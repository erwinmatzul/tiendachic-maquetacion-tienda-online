...
**Landing page de tienda online** diseñada con HTML5 y Bootstrap 5, enfocada en maquetación profesional, diseño moderno y estructura responsive. Este proyecto no contiene funcionalidades dinámicas, su objetivo principal es la maquetación y estructuración de interfaces web.
...
Practicar y reforzar **maquetación profesional y responsive design**, aplicando buenas prácticas de estructura de HTML semántico.
...
3. Integración con un backend (Node.js, Express y MongoDB)
